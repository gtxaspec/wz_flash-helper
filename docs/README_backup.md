...
4. Wait for the camera to restart after wcv3_flasher-helper finishes backup operation. Then turn the off camera, remove your SD card, and check `wz_flash-helper.log` on your SD card to see if everything looks fine and there is no error.
