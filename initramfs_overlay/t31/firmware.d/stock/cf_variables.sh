...
cf_all_partname_list="boot kernel rootfs app kback aback cfg para"
...
cf_restore_partname_list="kernel rootfs app kback aback cfg para"

## Name of SD card kernel
cf_sdcard_kernel_name="factory_t31_ZMC6tiIDQN"
