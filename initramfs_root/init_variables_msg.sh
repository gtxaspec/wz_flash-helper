...
backup_partitions_succeed="Backup operation is successful"
...
restore_partitions_succeed="Restore operation is successful"
...
switch_profile_succeed="Switch profile operation is successful"
...
enable_custom_script_succeed="Custom script running is successful"
...
copy_new_sdcard_kernelimg_succeed="Copying new sdcard kernel image is successful"
